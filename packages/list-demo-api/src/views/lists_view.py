...
def get():
    ...
    return jsonify(user_utilities.get_list_of_user(g.current_user_id))
...
def post():
    ...
    if list_element_action == 'add':
        ...
        return list_utilities.add_to_list(list_element, g.current_user_id)
    elif list_element_action == 'delete':
        list_element_id = request.get_json()['id']
        return list_utilities.delete_from_list(list_element_id, g.current_user_id)
    else:
