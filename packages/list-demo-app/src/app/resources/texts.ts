export const texts = {
  ...
  'app.component.settings.alert.notAvailable': 'Advanced settings are not available for your Account. You Signed In with a third-party-provider such as Google or Github. If you want to change your password, email or name please contact your provider. You can delete your account including all your information below.',
  ...
  'app.component.sign-in.noAccount.link': 'Sign up',
  'app.component.sign-in.button.email-sign-in': 'Login with E-Mail',
